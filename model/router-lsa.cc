...
RouterLsa::RouterLsa(bool bitV, bool bitE, bool bitB)
  : m_bitV(bitV),
    m_bitE(bitE),
    m_bitB(bitB)
{
...
{
  static TypeId tid = TypeId ("ns3::RouterLsa")
    .SetGroupName ("Ospf")
    .AddConstructor<RouterLsa> ()
  ;
  return tid;
}
TypeId 
...
uint16_t setFlags(bool V, bool E, bool B) {
...
void extractFlags(uint16_t field, bool &V, bool &E, bool &B) {
